new Vue({
    ...
    methods: {
      ...
      fetchNews() {
        // GUNAKAN API SEBENARNYA jika sudah punya
        // const apiKey = "YOUR_NEWSAPI_KEY";
        // const url = `https://newsapi.org/v2/top-headlines?language=id&pageSize=6&apiKey=${apiKey}`;
        ...
        this.news = [
          ...
          {
            title: "Terungkap, Modus Dokter Residen Anestesi di Bandung Bius Korban Sebelum Perkosa",
            source: { name: "Kompas" },
