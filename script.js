new Vue({
  ...
  methods: {
        ...
        .then(data => {
          ...
          if (data.query && data.query.pages) {
            this.results = Object.values(data.query.pages).map(page => ({
              ...
              image: page.thumbnail ? page.thumbnail.source : "https://via.placeholder.com/150?text=No+Image",
              extraInfo: "",
              newInfo: "",
              comments: [],
              newComment: ""
    ...
    addExtraInfo(item) {
      if (item.newInfo && item.newInfo.trim() !== "") {
        item.extraInfo = item.newInfo.trim();
        item.newInfo = "";
      }
    },
    addComment(item) {
    ...
    fetchNews() {
      this.news = [
        {
          title: "Kronologi Titiek Puspa Jatuh Sakit hingga Meninggal Dunia",
          ...
          urlToImage: "https://akcdn.detik.net.id/visual/2017/11/21/199ff8b7-ff3d-450c-bc8d-9dacf8a8f000_169.jpg?w=280&q=90",
        },
        {
          title: "Harga Emas Hari Ini, 10 April 2025: Antam, UBS, Galeri 24 Naik Tajam",
          source: { name: "Kompas" },
          ...
          urlToImage: "https://asset.kompas.com/crops/48OoZEgbg311pRxdydiNQnouubA=/450x301:4046x2699/1200x800/data/photo/2025/03/24/67e0e5c5d5db7.jpg",
        },
        {
          title: "Terungkap, Modus Dokter Residen Anestesi di Bandung Bius Korban",
          source: { name: "Kompas" },
          ...
          urlToImage: "https://asset.kompas.com/crops/52c-tWOZj1_40tzfBtqq4OH9ipE=/0x0:800x533/1200x800/data/photo/2025/04/09/67f65f3c1eb38.jpeg",
        },
      ];
